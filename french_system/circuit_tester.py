...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 30 17:30:54 2019
...
#print(sum(net.res_line.equal_or_greater_than_100))

#print((net.line.index).max)

x = range(0,5)
for i in x:
    
    net.line.at[i, 'r_ohm_per_km'] = 50
...
#
#for i, row in net.line():
   # new_val = 1000000
   # net.line.at[i, 'r_ohm_per_km'] = new_val
