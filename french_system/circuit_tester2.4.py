...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  3 22:19:42 2019
...
for i in x:
    try:
        ...
        #print(net.res_line.index[i])
        #print(net.res_line.index)
        #index_number = (net.res_line.iloc[i, 'Index']).read()
        ...
        with open('/Users/thomasjhojlunddodd/documents/lpthw/Sy1/power_plants/results.csv', 'a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(["COCKUP", "Cockup", "cockup"])   
